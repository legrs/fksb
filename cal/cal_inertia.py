...
objMass= [
        ...
        19.0,          # wheel of Xmotor
        19.0,          # wheel of Ymotor
        19.0,          # wheel of Zmotor
...
for i in range(len(objName)):
    ...
    for j in range(len(obj.Shape.Solids)):
        ...
        com[0] = com[0] + cog.x*obj.Shape.Solids[j].Volume*density
        com[1] = com[1] + cog.y*obj.Shape.Solids[j].Volume*density
        com[2] = com[2] + cog.z*obj.Shape.Solids[j].Volume*density
...
print("text for GodotC#")
print("    static float cm = ",mass,"F;", sep="")
print("    static float COMx = ",com[0],"F;", sep="")
print("    static float COMy = ",com[1],"F;", sep="")
print("    static float COMz = ",com[2],"F;", sep="")
print("    static double Ixx = ",moi[0],";", sep="")
